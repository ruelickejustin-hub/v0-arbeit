...
export const mockVerweise: Unterweisungsverweis[] = [
  ...
  // U1: Werksregeln & Risikomanagement
  {
    ...
    FolderPath: 'Q1/U1',
    FileName: 'werksregeln-praesentation.pptx',
    OpenMode: 'newTab',
  },
  {
    id: generateId(),
    Title: 'Risikomanagement Video',
    QuarterId: 'Q1',
    QuarterTitle: 'Q1 – Sicher starten',
    ModuleId: '2026_Q1_U1',
    ModuleTitle: 'Werksregeln & Risikomanagement',
    DocType: 'Video',
    DocCategory: 'Unterweisung',
    LinkLabel: 'Video: Risiken erkennen und melden',
    ShowInTraining: true,
    SortOrder: 2,
    ServerRelativeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q1/U1',
    FileName: 'risikomanagement-video.mp4',
    OpenMode: 'newTab',
  },
  {
    id: generateId(),
  ...
  // U2: Arbeiten in der Höhe & sichere Zugänge
  {
    ...
    ShowInTraining: true,
    SortOrder: 1,
    ServerRelativeUrl: '/sites/ehs/content/Q1/U2/hoehenarbeit.pptx',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q1/U2',
  ...
  },
  {
    ...
    ShowInTraining: true,
    SortOrder: 2,
    ServerRelativeUrl: '/sites/ehs/content/Q1/U2/leitern-video.mp4',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q1/U2',
  ...
  // U1: Transport- und Hebevorgänge
  {
    ...
    ShowInTraining: true,
    SortOrder: 1,
    ServerRelativeUrl: '/sites/ehs/content/Q2/U1/transport-heben.pptx',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q2/U1',
    FileName: 'transport-heben.pptx',
    OpenMode: 'newTab',
  },
  {
    id: generateId(),
  ...
  // U2: Maschinen, LOTO & elektrische Sicherheit
  {
    ...
    ShowInTraining: true,
    SortOrder: 1,
    ServerRelativeUrl: '/sites/ehs/content/Q2/U2/maschinen-loto.pptx',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q2/U2',
    FileName: 'maschinen-loto.pptx',
    OpenMode: 'newTab',
  },
  {
    id: generateId(),
    ...
    ShowInTraining: true,
    SortOrder: 2,
    ServerRelativeUrl: '/sites/ehs/content/Q2/U2/loto-video.mp4',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q2/U2',
    FileName: 'loto-video.mp4',
    OpenMode: 'newTab',
  },
  {
    id: generateId(),
  ...
  // U1: Gefahrstoffe & Umwelt
  {
    ...
    ShowInTraining: true,
    SortOrder: 1,
    ServerRelativeUrl: '/sites/ehs/content/Q3/U1/gefahrstoffe.pptx',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q3/U1',
  ...
  },
  {
    ...
    ShowInTraining: true,
    SortOrder: 2,
    ServerRelativeUrl: '/sites/ehs/content/Q3/U1/ghs-kennzeichnung.mp4',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q3/U1',
  ...
  // U2: PSA Basics & Handschutz
  {
    ...
    ShowInTraining: true,
    SortOrder: 1,
    ServerRelativeUrl: '/sites/ehs/content/Q3/U2/psa-basics.pptx',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q3/U2',
    FileName: 'psa-basics.pptx',
    OpenMode: 'newTab',
  },
  {
    id: generateId(),
  ...
  // U1: PSAgA & Spezial-PSA
  {
    ...
    ShowInTraining: true,
    SortOrder: 1,
    ServerRelativeUrl: '/sites/ehs/content/Q4/U1/psaga.pptx',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q4/U1',
    FileName: 'psaga.pptx',
    OpenMode: 'newTab',
  ...
  // U2: Compliance, Meldung & Brandschutz
  {
    ...
    ShowInTraining: true,
    SortOrder: 1,
    ServerRelativeUrl: '/sites/ehs/content/Q4/U2/compliance-meldung.pptx',
    LibraryName: 'EHS-Content',
    FolderPath: 'Q4/U2',
    FileName: 'compliance-meldung.pptx',
    OpenMode: 'newTab',
  },
  {
    id: generateId(),
